...
class ConsumersTest < ApplicationSystemTestCase
  ...
  test "creating a Consumer" do
    ...
    fill_in "City", with: @consumer.city
    fill_in "Description", with: @consumer.description
    fill_in "Email", with: @consumer.email
    fill_in "Name", with: @consumer.name
    fill_in "Phone", with: @consumer.phone
    fill_in "Postal code", with: @consumer.postal_code
    fill_in "Street", with: @consumer.street
